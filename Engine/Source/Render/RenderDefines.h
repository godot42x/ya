...
YA_REFLECT_ENUM_BEGIN(ya::EFilter::T)
YA_REFLECT_ENUM_VALUE(Nearest)
YA_REFLECT_ENUM_VALUE(Linear)
YA_REFLECT_ENUM_VALUE(CubicExt)
YA_REFLECT_ENUM_VALUE(CubicImg)
YA_REFLECT_ENUM_END()

YA_REFLECT_ENUM_BEGIN(ya::ESamplerAddressMode::T)
YA_REFLECT_ENUM_VALUE(Repeat)

...
struct CommandBuffer
{
    ...
    virtual SDL_GPUTexture *createTexture(std::string_view filepath)                                                               = 0;
    virtual SDL_GPUTexture *createTextureFromBuffer(const void *data, uint32_t width, uint32_t height, const char *name = nullptr) = 0;

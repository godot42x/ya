...
struct YA_GAME_RUNTIME_API ImGuiManager
{
  private:
  ...
  public:
    ...
    void initVulkan(INativeWindow* window, IRender* render, IRenderPass* renderPass);

#if IMGUI_SDL3_GPU
    void initSDLGPU(INativeWindow* window, SDL_GPUDevice* device);
#endif
...
YA_GAME_RUNTIME_API void BeginFrame();

YA_GAME_RUNTIME_API bool Image(IImageView*        imageView,
                      Sampler*           sampler,
...
YA_GAME_RUNTIME_API void ClearImageCache();

...
target("ya-scene-core")
    ...
    add_deps("ya-foundation-core", "ya-ecs-core", "ya-hierarchy", "ya-gui-scene", "ya-gui-widgets", "ya-scene-3d", "ya-resource-runtime", { public = true })
    add_deps("ya-resource-core", "ya-resource-loader")

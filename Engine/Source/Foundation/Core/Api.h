...
// One line per module, aligned with the module target names in
// Source/<tier>/<module>/xmake.lua. Identical resolution by design while the
// aggregate stays the single shared boundary (see
// .agent/plan/gui-framework-module-split).
#define YA_CORE_API         YA_API_EXPORT
#define YA_RHI_API          YA_API_EXPORT
#define YA_RHI_BACKEND_API  YA_API_EXPORT
#define YA_GUI_API          YA_API_EXPORT
...
#define YA_GAMEPLAY_ECS_API YA_API_EXPORT
